...
- **Remplacement d'un générateur de chaleur** : ne jamais recommander une technologie spécifique (« pompe à chaleur air-eau », « chaudière à pellets »…) sans que l'utilisateur l'ait explicitement indiqué. Préférer la formulation générique **« un système exploitant les énergies renouvelables »** et, si utile, lister entre parenthèses les options possibles (« pompe à chaleur, chaudière à pellets, raccordement CAD… ») en précisant que le choix définitif dépendra des contraintes du bâtiment et des opportunités locales. Cette prudence vaut pour toutes les sections concernées (Chauffage, Eau chaude sanitaire).
- **Canton de Vaud — DACCE (chauffages et chauffe-eau électriques)** : lorsque le bâtiment se situe dans le **canton de Vaud** ET qu'il est équipé d'un chauffage électrique direct, d'un chauffage électrique centralisé, et/ou d'un chauffe-eau électrique, **mentionner obligatoirement** le Décret sur l'assainissement des chauffages et chauffe-eau électriques (DACCE, RSV 730.051) dans la section Chauffage et/ou Eau chaude sanitaire concernée. Rappeler : (1) que le décret est en vigueur depuis le **1ᵉʳ janvier 2025**, (2) que l'**obligation d'annonce** auprès de la DGE-DIREN (ou du distributeur d'énergie) devait être effectuée **avant fin juin 2025**, (3) que le **délai de remplacement** est fixé au **1ᵉʳ janvier 2033**, (4) que le remplacement doit se faire par un système fonctionnant majoritairement aux énergies renouvelables, ou (pour les chauffages décentralisés sans réseau de distribution) par un assainissement de l'enveloppe. Dans ce cas, les travaux ne sont **pas** « à long terme » mais constituent une **obligation légale à court ou moyen terme**. Hors canton de Vaud, le DACCE ne s'applique pas — se référer à la législation cantonale en vigueur (MoPEC pour les cantons adhérents, particularités genevoises pour GE, etc.). Vérifier ponctuellement l'actualité de la réglementation via `WebFetch` sur [vd.ch/environnement/energie/legislation/chauffages-et-chauffe-eaux-electriques](https://www.vd.ch/environnement/energie/legislation/chauffages-et-chauffe-eaux-electriques) si un doute subsiste.
...
>
> *Améliorations possibles :* Il est recommandé de procéder au remplacement du système de production de chaleur actuel par un système exploitant les énergies renouvelables (pompe à chaleur, chaudière à pellets, raccordement à un réseau de chauffage à distance…), selon les contraintes du bâtiment et les opportunités locales. Il convient de noter que la création initiale d'un réseau de distribution hydraulique bénéficie d'un soutien financier dans le cadre du Programme Bâtiments. Le remplacement d'un système principal fonctionnant au mazout, au gaz ou à l'électricité directe est également subventionné par le Programme Bâtiments, à condition qu'il soit remplacé par un système utilisant des énergies renouvelables ou par un raccordement à un réseau de chauffage à distance. Pour les bâtiments construits avant l'an 2000, il est requis de justifier d'une classe CECB® de l'enveloppe comprise entre A et E (conformément à la mise à jour 2023).
>
> **⚠️ Canton de Vaud — Décret DACCE (RSV 730.051) :** depuis le 1ᵉʳ janvier 2025, le Décret sur l'assainissement des chauffages et chauffe-eau électriques est en vigueur dans le canton de Vaud. Il impose aux propriétaires le remplacement obligatoire de leur installation de chauffage électrique (direct ou centralisé) **au plus tard le 1ᵉʳ janvier 2033**. Les propriétaires devaient s'annoncer à la DGE-DIREN (ou via leur distributeur d'énergie) avant fin juin 2025. Pour un chauffage centralisé (avec réseau de distribution de chaleur), le remplacement doit se faire par une installation fonctionnant majoritairement aux énergies renouvelables. Pour un chauffage décentralisé (sans réseau de distribution), trois options sont prévues : remplacement par un système aux énergies renouvelables, assainissement de l'enveloppe thermique du bâtiment, ou une combinaison des deux. Ces travaux ne sont donc plus à envisager à « long terme » — ils constituent désormais **une obligation légale à court ou moyen terme**. Dans le canton de Genève ou les autres cantons, le DACCE ne s'applique pas ; se référer à la législation cantonale en vigueur.
...
>
> *Améliorations possibles :* Il est recommandé d'envisager l'installation d'un système de panneaux solaires photovoltaïques [sur une toiture préalablement rénovée]. L'autoproduction d'électricité présente généralement des avantages économiques et contribue à la réduction des émissions de gaz à effet de serre. Une étude d'ensoleillement devra être réalisée pour confirmer la faisabilité technique, en tenant compte notamment de l'ombrage potentiel et de l'orientation de la toiture. Les travaux d'installation d'un système photovoltaïque bénéficient de subventions de Pronovo, dont le montant dépend de la taille de l'installation et de l'option retenue (rétribution unique ou rétribution à l'injection). [Si PAC existante ou remplacement de chauffage recommandé : Le couplage d'une éventuelle pompe à chaleur avec une installation photovoltaïque est particulièrement pertinent.]
...
| DACCE — Chauffages et chauffe-eau électriques (VD) | https://www.vd.ch/environnement/energie/legislation/chauffages-et-chauffe-eaux-electriques | Décret VD en vigueur depuis 01.01.2025, délai de remplacement 01.01.2033 |
